<?php if (!defined('THINK_PATH')) exit(); require APP_ROOT.'public/head.php'; $type_id = pg('type_id'); ?>
...
<div class="content">
  ...
  <a href="javascript:;" onclick="dialog_div(500,300,'admin.php?m=input&a=add&type_id=<?php echo $type_id;?>&time=<?php echo time()?>')" class="button">添加表单</a>
