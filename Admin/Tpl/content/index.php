				...
				?>
					<tr>
						...
						<td>
							...
							<?php if($type_id==3){
							?>
                            <!-- <a class="con_list" href="admin.php?m=content&a=biaoqian&type_id=70&classify_id=<?php echo $classify_id;?>&content_id=<?php echo $v[$table_name.'_id'];?>">标签(<?php echo M('biaoqian')->where(array('goods_id' => $v['content_id']))->count();?>)</a> -->
                            <?php }?>
						</td>
