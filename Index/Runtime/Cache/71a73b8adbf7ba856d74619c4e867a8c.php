        ...
        <div class="container clearFix">
            ...
            <div class="rightcont">
                ...
                <div class="keyword">标签：
                    <?php
 $label = unserialize($goods['biaoqian']); foreach($label as $k=>$v){ $goods_label=M('label')->where(array('label_id'=>$v))->find(); echo $goods_label['label_title'].','; } ?>
                    阅读
                ...
                <div class="x_g">相关：
                    <?php  foreach($label as $k=>$v){ $new_label=M('label')->where(array('label_id'=>$v))->find(); ?>
